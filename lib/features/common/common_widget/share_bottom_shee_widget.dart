...
class ShareBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final textStyle = isDark
        ? TextStyle(color: Colors.white70, fontSize: SizeConfig.getHeight(context, 14))
        : TextStyle(color: Colors.black87, fontSize: SizeConfig.getHeight(context, 14));
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(SizeConfig.getHeight(context, 2.5)),
              ),
            ),
                  ...
                  return GestureDetector(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(option['label'] as String, style: textStyle, textAlign: TextAlign.center),
                      ],
                    ),
                  );
                },
